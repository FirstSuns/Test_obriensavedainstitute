...
// load viewer library
 ...
 if (isset($_POST['submit'])) {
   ...
   if(isset($_POST['phone']) && empty($_POST['phone']) || !isset($_POST['phone'])){
    ...
    if(isset($_POST['tour']) && empty($_POST['tour']) || !isset($_POST['tour'])){
      $arrError['tour'] ='<div class ="c-error">Please Select Tour</div>';
    }
