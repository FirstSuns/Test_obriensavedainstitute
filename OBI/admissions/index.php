<?php
  ...
  // load record from 'admissions_overview'
  list($admissions_overviewRecords, $admissions_overviewMetaData) = getRecords(array(
    'tableName'   => 'admissions_overview',
    'where'       => '', // load first record
    'loadUploads' => true,
    'allowSearch' => false,
    'limit'       => '1',
  ));
  $admissions_overviewRecord = @$admissions_overviewRecords[0]; ?>
<?php
  /* STEP 1: LOAD RECORDS - Copy this PHP code block near the TOP of your page */
...
<title><?php echo htmlencode($admissions_overviewRecord['meta_title']) ?></title>
<meta name="description" content="<?php echo htmlencode($admissions_overviewRecord['meta_description']) ?>" />
<meta name="keywords" content="<?php echo htmlencode($admissions_overviewRecord['meta_keywords']) ?>" />
...
<?php foreach ($admissions_overviewRecord['header_image'] as $index => $upload): ?>
  <div style="color:<?php echo htmlencode($upload['info2']) ?>">
    <div class="billboardtext2" style="color:<?php echo htmlencode($upload['info2']) ?>">ADMISSIONS
...
<div class="wrapper">
<?php echo htmlencode($admissions_overviewRecord['sub_text']) ?></div></div>
...
<?php echo $admissions_overviewRecord['content']; ?>  <div style="clear: both;"></div> 
</div>
</div>
