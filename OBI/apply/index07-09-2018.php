...
<title>Apply | O'Briens Aveda Institute | So. Burlington, VT</title>
        ...
        var myCallBack = function() {
          ...
          var correctrecaptcha1 = function(response) {
			...
			$(document).ready(function(){			 
				...
				input_credit_card(document.getElementById('soc_secu_number'));
			});
          </script>
</head>
...
<div class="royalSlider rsDefault">
  ...
  <div style="position: relative; color:<?php echo htmlencode($upload['info2']) ?>">
    <div class="billboardtext2">APPLY TODAY!
    <div class="billboardsubtext">Turn your passion into a profession</div>
    </div>
...
<div class="wrapper">
Begin your AVEDA Experience by completing the application below and or call us at 802.876.7044 and we'll contact you promptly with all the information you need to begin your education.</div></div>
<div class="programssub">
<div class="wrapper">
	We do not discriminate on the basis of race, color, religion, sex, national origin, age, disability, or any other basis prohibited by federal, state, or local law. No question on this form is intended to secure information to be used for such discrimination. The school is required to report some of the information requested below. Your contribution is voluntary. It will be held confidential.<br /><br /><br />
	...
	<div class="formfield">
		...
		<input id="soc_secu_number" name="soc_secu_number" type="text" value="<?php if(isset($_POST['soc_secu_number']) && !empty($_POST['soc_secu_number'])) { echo $_POST['soc_secu_number'];}?>" class="textfield1"/>
		</br>
	...
	<div class="formfield2">
		...
		<select id="hear" name="hear" size="1" class="dropdown">
			<option value="">Select One</option>
			<option <?php if(isset($_POST['hear']) && $_POST['hear'] == 'Career Fair - High School Visit') { echo 'selected=selected';}?> value="Career Fair - High School Visit">Career Fair/High School Visit</option>
			...
			<option <?php if(isset($_POST['hear']) && $_POST['hear'] == 'Salon') { echo 'selected=selected';}?> value="Salon">Salon</option>
			<option <?php if(isset($_POST['hear']) && $_POST['hear'] == 'Sevendays') { echo 'selected=selected';}?> value="Sevendays">Sevendays</option>
			<option <?php if(isset($_POST['hear']) && $_POST['hear'] == 'Twitter') { echo 'selected=selected';}?> value="Twitter">Twitter</option>
			<option <?php if(isset($_POST['hear']) && $_POST['hear'] == 'TV') { echo 'selected=selected';}?> value="TV">TV</option>
			<option <?php if(isset($_POST['hear']) && $_POST['hear'] == 'Word of Mouth') { echo 'selected=selected';}?> value="Word of Mouth">Word of Mouth</option>
