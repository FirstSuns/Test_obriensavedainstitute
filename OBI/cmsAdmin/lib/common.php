...
function saveStruct($filepath, $struct, $sortKeys = false, $headerMessage = '') { // $headerMessage added in 2.18
  ...
  if (function_exists('opcache_invalidate')) { @opcache_invalidate($filepath, true); } // @hide warnings: Rackspace Cloud returns: E_WARNING: Zend OPcache API is restricted by "restrict_api" configuration directive.  Future: Detect if opcache.restrict_api is set?
