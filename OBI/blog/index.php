...
<title>Blog | O'Briens Aveda Institute | So. Burlington, VT</title>
...
<?php foreach ($blogRecords as $record): ?>
	...
	<div class="programimgsub" <?php foreach ($record['image'] as $index => $upload): ?>style="background-image:url(<?php echo htmlencode($upload['urlPath']) ?>)"<?php endforeach ?>></div>
	<h4 style="padding:0px; marging:0px;"><?php echo htmlencode($record['title']) ?></h4>
    <div style="color:#ccc;"><?php echo htmlencode($record['blurb']) ?></div>
    <div class="subbutton"><img src="../images/arrowsblack.png" width="22" height="21" alt="" style="vertical-align:middle"/> <a href="<?php echo $record['_link'] ?>">READ MORE </a>     </div>
