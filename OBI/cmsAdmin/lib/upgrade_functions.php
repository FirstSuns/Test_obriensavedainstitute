...
function _upgradeToVersion1_24() {
  ...
  mysql_query("ALTER TABLE `$debugTable` CHANGE COLUMN `$debugField` `$debugField` int(10) unsigned DEFAULT NULL") or die("Mysql error:\n\n". htmlencode(mysql_error()) . " in " .__FILE__ . ", line " .__LINE__);

  // DEBUG - show table
  //$result = mysql_query("SHOW CREATE TABLE `{$TABLE_PREFIX}_accesslist`");
