<?php
  ...
  // load record from 'about_us_pages'
  ...
  $about_us_pagesRecord = @$about_us_pagesRecords[0]; 
?>
<?php
  /* STEP 1: LOAD RECORDS - Copy this PHP code block near the TOP of your page */
  ...
  // load records from 'about_us_pages'
  list($about_us_pagesRecords, $about_us_pagesMetaData) = getRecords(array(
    'tableName'   => 'about_us_pages',
    'loadUploads' => true,
    'allowSearch' => false,
...
<title><?php echo htmlencode($about_us_pagesRecord['meta_title']) ?></title>
<meta name="description" content="<?php echo htmlencode($about_us_pagesRecord['meta_description']) ?>" />
<meta name="keywords" content="<?php echo htmlencode($about_us_pagesRecord['meta_keywords']) ?>" />
...
<?php foreach ($about_us_pagesRecord['header_image'] as $index => $upload): ?>
  <div style="position: relative; color:<?php echo htmlencode($upload['info3']) ?>">
    <div class="billboardtext2"style="color:<?php echo htmlencode($upload['info3']) ?>"><?php echo htmlencode($about_us_pagesRecord['title']) ?>
    </div>
...
<div class="wrapper">
<?php echo htmlencode($about_us_pagesRecord['sub_text']) ?></div></div>
...
<?php echo $about_us_pagesRecord['content']; ?> <div style="clear: both;"></div> 
</div>
</div>
