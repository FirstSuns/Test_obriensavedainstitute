                ...
                <div class="col-xs-12 col-sm-8 col-md-6 col-lg-3 nopadding">
                  <div class="input-group">
                    ...
                    <div class="input-group-btn">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right menu-icon-select" style="-moz-column-count:3; -webkit-column-count:3; column-count:3; -webkit-column-gap: 0; -moz-column-gap: 0; column-gap: 0;">
                        <?php
