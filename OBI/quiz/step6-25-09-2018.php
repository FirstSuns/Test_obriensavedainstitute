...
<div class="wrapper">
<h5>Fashion Photo Stylist</h5>
[FIRST NAME],<br />
YOU ARE A PERFECT FIT TO BE A FASHION SHOW STYLIST.<br />
WHERE YOU WILL GET FASHION MODELS READY FOR THE RUNWAY.<br /><br />


<div style="clear: both; height:40px;"></div>
<div class="quizbutton2">SHARE ON FACEBOOK</div><div style="clear: both;"></div></div>
</div>
